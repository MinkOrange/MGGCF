...
def parse_args():
    parser = argparse.ArgumentParser(description="Run MGGCF.")
    ...
    parser.add_argument('--lr', type=float, default=0.0005,
                        help='Learning rate.')
    parser.add_argument('--num_negatives', nargs='?', default= 4,
                        help='Number of negative samples')

    parser.add_argument('--model_type', nargs='?', default='MGGCF',
                        help='Specify the name of model (MGGCF).')
